...
annFile = 'annotations/quora_prepro_test_updated_int.json'
coco = COCO(annFile)
valids = coco.getQuesCapIds() #should return ques_cap_id, unique id 
# print 'valids quescapid' ,valids
checkpoint = json.load(open(input_json, 'r'))
preds = checkpoint['val_predictions']
# print 'preds val_prediction: ',preds
# filter results to only those in MSCOCO validation set (will be about a third)
preds_filt = [p for p in preds if p['image_id'] in valids] ## need to chanage here
